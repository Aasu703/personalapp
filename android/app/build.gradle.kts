...
// Copy key.properties.example to key.properties and fill in your keystore
// details before running a release build or a fastlane store lane.
...
android {
    ...
    buildTypes {
        release {
            ...
            // so `flutter run --release` keeps working before signing is set up.
